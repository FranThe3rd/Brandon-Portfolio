    ...
    <div className='home'>
      ...
      <div className='recent'>
        ...
        <div className='recent-grid'>
          <video className='hidden' playsinline controls loop muted autoPlay src={vid1}></video>
          <video className='hidden' playsinline controls loop muted autoPlay src={vid2}></video>
          <video className='hidden' playsinline controls loop muted autoPlay src={vid3}></video>
          <video className='hidden' playsinline controls loop muted autoPlay src={vid4}></video>
        </div>
      </div>
